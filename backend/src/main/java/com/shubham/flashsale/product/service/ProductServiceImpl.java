...
public class ProductServiceImpl implements ProductService {
  ...
  public ProductResponse createProduct(CreateProductRequest request) {
    ...
    log.info("Product created id={} uuid={}", savedProduct.getId(), savedProduct.getUuid());

    return mapToResponse(savedProduct);
  }

  @Override
  @Cacheable(cacheNames = CacheNames.PRODUCT, key = "#productUuid")
  public ProductResponse getProduct(String productUuid) {
