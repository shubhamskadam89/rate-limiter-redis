...
public class RefreshTokenService {
  ...
  public RefreshToken validateRefreshToken(String token) {
    ...
    RefreshToken refreshToken =
        refreshTokenRepository.findByToken(token).orElseThrow(RefreshTokenNotFoundException::new);
    ...
    log.debug(
        "Refresh token validated successfully for user uuid={}", refreshToken.getUser().getUuid());
    return refreshToken;
  }
